    ...
    def draw(self, screen):
        ...
        for r in range(DIMENSION):
            for c in range(DIMENSION):
                ...
                pygame.draw.rect(screen, color, pygame.Rect((c*SQ_SIZE) + ((WIDTH - B_WIDTH) // 2) - 64, (r*SQ_SIZE) + (HEIGHT - B_HEIGHT) // 2, SQ_SIZE, SQ_SIZE))  # Adjusted position
        ...
        for c in range(DIMENSION):  # Vertical lines
            ...
            screen.blit(col_text, (c * SQ_SIZE + ((WIDTH - B_WIDTH) // 2) - 64 + SQ_SIZE // 2, (HEIGHT - B_HEIGHT) // 2 + B_HEIGHT))
        ...
        for r in range(DIMENSION):
            for c in range(DIMENSION):
                ...
                if piece != " ": #not empty square
                    screen.blit(IMAGES[piece], pygame.Rect((c*SQ_SIZE) + ((WIDTH - B_WIDTH) // 2) - 64, (r*SQ_SIZE) + (HEIGHT - B_HEIGHT) // 2, SQ_SIZE, SQ_SIZE))  # Adjusted position
...
class ChessGUI:
    ...
    def highlight_valid_moves(self):
        ...
        for move in self.valid_moves:
            row, col = move
            pygame.draw.rect(screen, pygame.Color("light green"), pygame.Rect((col * SQ_SIZE) + ((WIDTH - B_WIDTH) // 2) - 64, (row * SQ_SIZE) + (HEIGHT - B_HEIGHT) // 2, SQ_SIZE, SQ_SIZE))
...
class ChessboardScene:
    ...
    def element(self, events):
        pass
>>>>>>> 41d07f8e07842a740ceadca7660924ce732a89c2:UI/ui.py
