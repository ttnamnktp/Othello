...
greedy_ai = AI(heuristic=StaticWeight(), algorithm=Greedy, depth=1)
minimax_ai = AI(heuristic=StaticWeight(), algorithm=Minimax, depth=3)
minimax_alpha_beta_ai = AI(heuristic=StaticWeight(), algorithm=MinimaxAlphaBeta, depth=5, run_time=1)
mcts_ai = AI(heuristic= StaticWeight(), algorithm=MonteCarloTreeSearch, depth=3, run_time=1)

st1 = Statistic(random_ai,mcts_ai,"../../../statistic_file/algorithm_vs_algorithm/all_vs_mcts/statistic_static_weight/example1")
